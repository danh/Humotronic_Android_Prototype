...
public class UserFollowersEndlessListview extends ListView implements OnScrollListener{
	...
	// CONSTRUCTOR ---------------------------------------------------------------------------
	public UserFollowersEndlessListview(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);	
		this.setOnScrollListener(this);
	}

	public UserFollowersEndlessListview(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.setOnScrollListener(this);
	}
	
	public UserFollowersEndlessListview(Context context) {
		super(context);
		this.setOnScrollListener(this);
	}
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		if (l >= totalItemCount && !isLoading && totalItemCount < totalNumberOfFollowers) {
	...
	public void setAdapter(UserFollowersAdapter adapter) {		
