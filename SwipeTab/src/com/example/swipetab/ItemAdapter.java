...
public class ItemAdapter extends BaseAdapter implements OnClickListener{
	...
	public View getView(int position, View view, ViewGroup viewGroup) {
		...
		if (view == null) {
			...
			gridView = inflater.inflate(R.layout.layout_single_item, null);
		...
		TextView itemName = (TextView) gridView.findViewById(R.id.itemName1);
		itemName.setText(itemValue[position]);

		ImageView imageView = (ImageView) gridView.findViewById(R.id.itemView1);
		imageView.setImageResource(R.drawable.item2);
		
		ImageView userView = (ImageView) gridView.findViewById(R.id.userImage1);
